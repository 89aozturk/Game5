...
namespace MernisServiceReference
{
    ...
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<MernisServiceReference.KPSPublicSoap>, MernisServiceReference.KPSPublicSoap
    {
        ...
        public System.Threading.Tasks.Task<MernisServiceReference.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, long nationalityId, string Ad, string Soyad, int DogumYili)
        {
        ...
        internal object TCKimlikNoDogrulaAsync(long nationalityId, string v1, string v2, int dateOfBirth)
        {
